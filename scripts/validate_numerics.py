"""
Test The VMFB Generated By Giving (Prompt Based).
...
def parse_args():
    ...
    parser.add_argument("--irpa", help="x")
    parser.add_argument("--vmfb", help="x")
    parser.add_argument("--model", help="x")
    parser.add_argument("--tokenizer", help="x")
    parser.add_argument("--tokenizer_config", help="x")
    parser.add_argument("--config", help="x")
    parser.add_argument("--steps", help="x")
    parser.add_argument("--kv-cache-dtype", dest="kv_cache_dtype", help="x")
