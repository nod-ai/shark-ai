...
// TORCH-CHECK:     func.func @main(%result_: !torch.tensor<[16,64,32,256],f32>, %arg0_image: !torch.vtensor<[16,64,32,128],f32>, %arg1_filter: !torch.vtensor<[256,1,1,16],f32>, %bias: !torch.vtensor<[1,1,1,256],f32>) attributes {torch.assume_strict_symbolic_shapes} {
...
test_conv_asm_emitter_x_nhwc_w_krsc_with_relu(const std::string &mode) {
  ...
  graph->setName("conv_grouped_asm_emitter_x_nhwc_w_krsc_with_relu");
