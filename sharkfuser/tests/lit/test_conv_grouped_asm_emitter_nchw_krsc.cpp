...
// TORCH-CHECK:     func.func @main(%result_: !torch.tensor<[16,256,64,32],f32>, %arg0_image: !torch.vtensor<[16,128,64,32],f32>, %arg1_filter: !torch.vtensor<[256,1,1,16],f32>) attributes {torch.assume_strict_symbolic_shapes} {
...
ErrorObject test_conv_asm_emitter_x_nchw_w_krsc(const std::string &mode) {
  ...
  graph->setName("conv_grouped_asm_emitter_x_nchw_w_krsc");
