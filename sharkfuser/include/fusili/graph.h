...
private:
  ...
  error_t preValidateNode() const override final { return ok(); }

  error_t inferPropertiesNode() override final { return ok(); }

  error_t postValidateNode() const override final { return ok(); }
