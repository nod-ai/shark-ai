...
from sharktank.layers.woof_attention_block import *
from sharktank.layers.wooffn_block import *
...
class PagedWoofModelV1(BaseCausalLMModel):
    ...
    def __init__(self, theta: Theta, config: LlamaModelConfig):
        ...
        ## THINGS TO ADD/ CHECK ##
        self.layer_to_kv_group = list(range(self.hp.block_count))
        for layers in config.hp.share_kv_sched:
        ...
        # ========== NEW TO WOOF ============= #
        self.embedding_scale = theta("embedding_scale.weight").as_torch()
        ...
        self.attn_blocks = nn.ModuleList(
            [
                WoofFFNBlock(
                    ...
                    is_context_encoder=n != self.layer_to_kv_group[n],
                )
