...
class KVCache:
    ...
    def read(
        ...
        *,
        ...
        page_table = self.unflatten_page_table(self.state)[0]
    ...
    def write(
        ...
        *,
        ...
        page_table = self.unflatten_page_table(state=self.state)[0]
