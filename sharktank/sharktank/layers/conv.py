...
class Conv3DLayer(ThetaLayer):
    ...
    def __init__(
        self, theta: Theta, padding: Optional[Tuple[int, int, int]] = None, stride: IntOrSequenceInt = 1
    ):
        super().__init__(theta)
...
class Conv1DLayer(ThetaLayer):
    ...
    def __init__(
        self, theta: Theta, padding: Optional[Tuple[int]] = None, stride: IntOrSequenceInt = 1
    ):
        super().__init__(theta)
