...
def get_wave_offset_prefill_asm(
...
def wave_offset_prefill(q_extend, k_extend, v_extend, k_cache, v_cache, 
    ...
    wave_kernel_name = f"wave_offset_prefill_{num_heads}_{q_s if q_s >= 0 else 'M_dyn'}_{v_d}_f16_f32"
